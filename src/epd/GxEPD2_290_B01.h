...
#ifndef _GxEPD2_290_B01_H_
#define _GxEPD2_290_B01_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_290_B01 : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 128;
    static const uint16_t HEIGHT = 296;
    static const GxEPD2::Panel panel = GxEPD2::DEPG0290B01;
    ...
    // constructor
    GxEPD2_290_B01(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
